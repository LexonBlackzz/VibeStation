...
struct CpuBackendStats {
  ...
  u64 native_prefix_ram_load_candidate_blocks = 0;
  u64 native_prefix_ram_load_entries = 0;
  u64 native_prefix_ram_load_instructions = 0;
  u64 native_prefix_ram_load_preflight_passes = 0;
  u64 native_prefix_ram_load_preflight_fallbacks = 0;
  u64 native_prefix_ram_load_preflight_mmio = 0;
  u64 native_prefix_ram_load_preflight_unaligned = 0;
  u64 native_prefix_ram_load_preflight_non_ram = 0;
  u64 native_prefix_ram_load_preflight_disabled = 0;
  u64 native_prefix_ram_load_preflight_direct_attempts = 0;
  u64 native_prefix_ram_load_preflight_full_attempts = 0;
  u64 native_prefix_ram_load_preflight_full_instructions = 0;
  u64 native_prefix_ram_load_aggressive_candidate_blocks = 0;
  u64 native_prefix_ram_load_aggressive_entries = 0;
  u64 native_prefix_ram_load_aggressive_instructions = 0;
  u64 native_prefix_ram_load_aggressive_base_written_blocks = 0;
  u64 native_prefix_ram_load_adaptive_repeated_failures = 0;
  u64 native_prefix_ram_load_adaptive_disabled_blocks = 0;
  u64 native_prefix_ram_load_adaptive_direct_entries = 0;
  u64 native_prefix_ram_load_adaptive_preflight_attempts_avoided = 0;
  u64 native_prefix_ram_load_adaptive_disable_mmio = 0;
  u64 native_prefix_ram_load_adaptive_disable_non_ram = 0;
  u64 native_prefix_ram_load_adaptive_disable_scratchpad = 0;
  u64 native_prefix_ram_load_adaptive_disable_unaligned = 0;
  u64 native_prefix_reject_load_fastpath_disabled = 0;
  u64 native_prefix_reject_load_base_written = 0;
  u64 native_prefix_reject_store = 0;
  u64 native_prefix_memory_reject_lw = 0;
  u64 native_prefix_memory_reject_lb = 0;
  u64 native_prefix_memory_reject_lbu = 0;
  u64 native_prefix_memory_reject_lh = 0;
  u64 native_prefix_memory_reject_lhu = 0;
  u64 native_prefix_memory_reject_sb = 0;
  u64 native_prefix_memory_reject_sh = 0;
  u64 native_prefix_memory_reject_sw = 0;
  u64 native_prefix_ram_load_blocker_bne = 0;
  u64 native_prefix_ram_load_blocker_beq = 0;
  u64 native_prefix_ram_load_blocker_jr = 0;
  u64 native_prefix_ram_load_blocker_cop2 = 0;
  u64 native_prefix_ram_load_blocker_other = 0;
  u64 cache_hits = 0;
  u64 cache_misses = 0;
  u64 invalidations = 0;
